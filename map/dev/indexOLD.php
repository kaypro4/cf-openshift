...
$("#map_canvas").width(width);
 ...
 var infoWindow = new google.maps.InfoWindow();
	...
	//sites
	//New way
	 var query = "SELECT col1, col4, col6, col7 FROM 18oQQl1jdoSdhqSJ-re1lLCVoDO_-DXXWVZWo35o";
     query = encodeURIComponent(query);
     var gvizSiteQuery = new google.visualization.Query('http://www.google.com/fusiontables/gvizdata?tq=' + query + '&key=AIzaSyAo1C_bwpagv3SWrZmT-Bj_Luh5O6l5bLs');
	...
	//trees
	//New way
	 var query = "SELECT col0, col1, col2, col3, col4, col5, col6 FROM 1EbzlO_Ez4u50g6faciaKSF4vM8qjyCCGoLtz5x8";
     query = encodeURIComponent(query);
     var gvizTreeQuery = new google.visualization.Query('http://www.google.com/fusiontables/gvizdata?tq=' + query + '&key=AIzaSyAo1C_bwpagv3SWrZmT-Bj_Luh5O6l5bLs');
	...
	if(id_value != "") {
		<?php
		$data = file_get_contents('https://www.googleapis.com/fusiontables/v1/query?sql=SELECT%20col1,%20col4,%20col6,%20col7%20FROM%2018oQQl1jdoSdhqSJ-re1lLCVoDO_-DXXWVZWo35o&key=AIzaSyAo1C_bwpagv3SWrZmT-Bj_Luh5O6l5bLs&alt=csv');
		$rows = explode("\n", $data);
