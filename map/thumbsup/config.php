...
return array(
	 ...
	 */
	'url' => 'http://cityfruit.org/map/thumbsup/',
	 ...
	 */
	'database_dsn' => 'mysql:dbname=votingscript;host=votingscript.db.10639522.hostedresource.com',

	/**
	 * (string) The username for the DSN string.
	 */
	'database_user' => 'votingscript',

	/**
	 * (string) The password for the DSN string.
	 */
	'database_pass' => 'Yub4uf!5re!a@',
	...
	'admin_users' => array(
		...
		'admin' => '9db3d4db1747a21e7f1cd6c9e63237d1f8f1a1c2',
	),
