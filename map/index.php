...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyASSbEOFHP8VQpNbocRIaELMjv2qL4MG0U&sensor=true"></script>
...
<style>
#map_canvas{width:100%;position:absolute;top:0px;bottom:0px;left:0;right:0;}
</style>
<?php } ?>
...
document.addEventListener('DOMContentLoaded', function () {
        ...
        element.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyASSbEOFHP8VQpNbocRIaELMjv2qL4MG0U&sensor=true&callback=Initialize';
	  ...
	  var marker = new google.maps.Marker({
		...
		zIndex: 1
          ...
          google.maps.event.addListener(marker, 'click', function(event) {
			...
			//'Rate the fruit:',
			'<iframe src="http://cityfruit.org/map/rate.php?ID=' + TreeID + '" width="200" height="125" seamless scrolling="no" frameBorder="0"></iframe>',
			'</div>'
			].join('');
...
<body>
	...
	<div data-role="page" data-theme="a">
		...
		<?php } ?>
			...
			<div style="position: absolute; bottom: 35px; right: 5px; <?php if (isset($_GET['hidenav'])) echo "display:none;" ?>" id="sitemenu">
